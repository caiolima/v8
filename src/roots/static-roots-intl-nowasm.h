...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kdefer_string = 0x412d;
  ...
  static constexpr Tagged_t knew_target_string = 0x4281;
  static constexpr Tagged_t kdot_result_string = 0x4299;
  ...
  static constexpr Tagged_t kdotAll_string = 0x42fd;
  static constexpr Tagged_t kError_string = 0x4311;
  static constexpr Tagged_t kEvalError_string = 0x4325;
  static constexpr Tagged_t kelement_string = 0x433d;
  static constexpr Tagged_t kepochMilliseconds_string = 0x4351;
  static constexpr Tagged_t kepochNanoseconds_string = 0x4371;
  static constexpr Tagged_t kera_string = 0x438d;
  static constexpr Tagged_t keraYear_string = 0x439d;
  static constexpr Tagged_t kerror_string = 0x43b1;
  static constexpr Tagged_t kerrors_string = 0x43c5;
  static constexpr Tagged_t kerror_to_string = 0x43d9;
  static constexpr Tagged_t keval_string = 0x43f5;
  static constexpr Tagged_t kexception_string = 0x4405;
  static constexpr Tagged_t kexec_string = 0x441d;
  static constexpr Tagged_t kfalse_string = 0x442d;
  static constexpr Tagged_t kfields_string = 0x4441;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x4455;
  static constexpr Tagged_t kflags_string = 0x4475;
  static constexpr Tagged_t kFloat16Array_string = 0x4489;
  static constexpr Tagged_t kFloat32Array_string = 0x44a1;
  static constexpr Tagged_t kFloat64Array_string = 0x44b9;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x44d1;
  static constexpr Tagged_t kfrom_string = 0x44f5;
  static constexpr Tagged_t kFunction_string = 0x4505;
  static constexpr Tagged_t kfunction_native_code_string = 0x4519;
  static constexpr Tagged_t kfunction_string = 0x4545;
  static constexpr Tagged_t kfunction_to_string = 0x4559;
  static constexpr Tagged_t kGenerator_string = 0x4579;
  static constexpr Tagged_t kget_space_string = 0x4591;
  static constexpr Tagged_t kget_string = 0x45a1;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x45b1;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x45d5;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x45f9;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x461d;
  static constexpr Tagged_t kgetTimeZoneTransition_string = 0x4639;
  static constexpr Tagged_t kglobal_string = 0x465d;
  static constexpr Tagged_t kglobalThis_string = 0x4671;
  static constexpr Tagged_t kgroups_string = 0x4689;
  static constexpr Tagged_t kgrowable_string = 0x469d;
  static constexpr Tagged_t khas_string = 0x46b1;
  static constexpr Tagged_t khasIndices_string = 0x46c1;
  static constexpr Tagged_t khour_string = 0x46d9;
  static constexpr Tagged_t khours_string = 0x46e9;
  static constexpr Tagged_t khoursInDay_string = 0x46fd;
  static constexpr Tagged_t kignoreCase_string = 0x4715;
  static constexpr Tagged_t kid_string = 0x472d;
  static constexpr Tagged_t killegal_access_string = 0x473d;
  static constexpr Tagged_t killegal_argument_string = 0x4759;
  static constexpr Tagged_t kinLeapYear_string = 0x4775;
  static constexpr Tagged_t kindex_string = 0x478d;
  static constexpr Tagged_t kindices_string = 0x47a1;
  static constexpr Tagged_t kInfinity_string = 0x47b5;
  static constexpr Tagged_t kinfinity_string = 0x47c9;
  static constexpr Tagged_t kinput_string = 0x47dd;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x47f1;
  static constexpr Tagged_t kInt16Array_string = 0x481d;
  static constexpr Tagged_t kInt32Array_string = 0x4835;
  static constexpr Tagged_t kInt8Array_string = 0x484d;
  static constexpr Tagged_t kisExtensible_string = 0x4865;
  static constexpr Tagged_t kiso8601_string = 0x487d;
  static constexpr Tagged_t kisoDay_string = 0x4891;
  static constexpr Tagged_t kisoHour_string = 0x48a5;
  static constexpr Tagged_t kisoMicrosecond_string = 0x48b9;
  static constexpr Tagged_t kisoMillisecond_string = 0x48d5;
  static constexpr Tagged_t kisoMinute_string = 0x48f1;
  static constexpr Tagged_t kisoMonth_string = 0x4909;
  static constexpr Tagged_t kisoNanosecond_string = 0x491d;
  static constexpr Tagged_t kisoSecond_string = 0x4939;
  static constexpr Tagged_t kisoYear_string = 0x4951;
  static constexpr Tagged_t kIterator_string = 0x4965;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4979;
  static constexpr Tagged_t kjsMemoryRange_string = 0x4995;
  static constexpr Tagged_t kkeys_string = 0x49b1;
  static constexpr Tagged_t klargestUnit_string = 0x49c1;
  static constexpr Tagged_t klast_chunk_handling_string = 0x49d9;
  static constexpr Tagged_t klastIndex_string = 0x49f9;
  static constexpr Tagged_t klet_string = 0x4a11;
  static constexpr Tagged_t kline_string = 0x4a21;
  static constexpr Tagged_t klinear_string = 0x4a31;
  static constexpr Tagged_t kLinkError_string = 0x4a45;
  static constexpr Tagged_t klong_string = 0x4a5d;
  static constexpr Tagged_t kMap_string = 0x4a6d;
  static constexpr Tagged_t kMapIterator_string = 0x4a7d;
  static constexpr Tagged_t kmax_byte_length_string = 0x4a95;
  static constexpr Tagged_t kmedium_string = 0x4ab1;
  static constexpr Tagged_t kmergeFields_string = 0x4ac5;
  static constexpr Tagged_t kmessage_string = 0x4add;
  static constexpr Tagged_t kmeta_string = 0x4af1;
  static constexpr Tagged_t kminus_Infinity_string = 0x4b01;
  static constexpr Tagged_t kmicrosecond_string = 0x4b19;
  static constexpr Tagged_t kmicroseconds_string = 0x4b31;
  static constexpr Tagged_t kmillisecond_string = 0x4b49;
  static constexpr Tagged_t kmilliseconds_string = 0x4b61;
  static constexpr Tagged_t kminute_string = 0x4b79;
  static constexpr Tagged_t kminutes_string = 0x4b8d;
  static constexpr Tagged_t kModule_string = 0x4ba1;
  static constexpr Tagged_t kmonth_string = 0x4bb5;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x4bc9;
  static constexpr Tagged_t kmonths_string = 0x4be9;
  static constexpr Tagged_t kmonthsInYear_string = 0x4bfd;
  static constexpr Tagged_t kmonthCode_string = 0x4c15;
  static constexpr Tagged_t kmultiline_string = 0x4c2d;
  static constexpr Tagged_t kNaN_string = 0x4c45;
  static constexpr Tagged_t knanosecond_string = 0x4c55;
  static constexpr Tagged_t knanoseconds_string = 0x4c6d;
  static constexpr Tagged_t knarrow_string = 0x4c85;
  static constexpr Tagged_t knative_string = 0x4c99;
  static constexpr Tagged_t kNFC_string = 0x4cad;
  static constexpr Tagged_t kNFD_string = 0x4cbd;
  static constexpr Tagged_t kNFKC_string = 0x4ccd;
  static constexpr Tagged_t kNFKD_string = 0x4cdd;
  static constexpr Tagged_t knot_equal_string = 0x4ced;
  static constexpr Tagged_t knull_string = 0x4d05;
  static constexpr Tagged_t knull_to_string = 0x4d15;
  static constexpr Tagged_t kNumber_string = 0x4d31;
  static constexpr Tagged_t knumber_string = 0x4d45;
  static constexpr Tagged_t knumber_to_string = 0x4d59;
  static constexpr Tagged_t kObject_string = 0x4d75;
  static constexpr Tagged_t kobject_string = 0x4d89;
  static constexpr Tagged_t kobject_to_string = 0x4d9d;
  static constexpr Tagged_t kObject_prototype_string = 0x4db9;
  static constexpr Tagged_t koffset_string = 0x4dd5;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x4de9;
  static constexpr Tagged_t kok_string = 0x4e09;
  static constexpr Tagged_t kother_string = 0x4e19;
  static constexpr Tagged_t koverflow_string = 0x4e2d;
  static constexpr Tagged_t kownKeys_string = 0x4e41;
  static constexpr Tagged_t kpercent_string = 0x4e55;
  static constexpr Tagged_t kplainDate_string = 0x4e69;
  static constexpr Tagged_t kplainTime_string = 0x4e81;
  static constexpr Tagged_t kposition_string = 0x4e99;
  static constexpr Tagged_t kpreventExtensions_string = 0x4ead;
  static constexpr Tagged_t kprivate_constructor_string = 0x4ecd;
  static constexpr Tagged_t kPromise_string = 0x4ee5;
  static constexpr Tagged_t kpromise_string = 0x4ef9;
  static constexpr Tagged_t kproto_string = 0x4f0d;
  static constexpr Tagged_t kproxy_string = 0x4f25;
  static constexpr Tagged_t kProxy_string = 0x4f39;
  static constexpr Tagged_t kquery_colon_string = 0x4f4d;
  static constexpr Tagged_t kRangeError_string = 0x4f5d;
  static constexpr Tagged_t kraw_json_string = 0x4f75;
  static constexpr Tagged_t kraw_string = 0x4f89;
  static constexpr Tagged_t kread_string = 0x4f99;
  static constexpr Tagged_t kReferenceError_string = 0x4fa9;
  static constexpr Tagged_t kReflectGet_string = 0x4fc5;
  static constexpr Tagged_t kReflectHas_string = 0x4fdd;
  static constexpr Tagged_t kRegExp_string = 0x4ff5;
  static constexpr Tagged_t kregexp_to_string = 0x5009;
  static constexpr Tagged_t kreject_string = 0x5025;
  static constexpr Tagged_t krelativeTo_string = 0x5039;
  static constexpr Tagged_t kresizable_string = 0x5051;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x5069;
  static constexpr Tagged_t kreturn_string = 0x5089;
  static constexpr Tagged_t krevoke_string = 0x509d;
  static constexpr Tagged_t kroundingIncrement_string = 0x50b1;
  static constexpr Tagged_t kroundingMode_string = 0x50d1;
  static constexpr Tagged_t kRuntimeError_string = 0x50e9;
  static constexpr Tagged_t kWebAssemblyException_string = 0x5101;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x5125;
  static constexpr Tagged_t kScript_string = 0x5145;
  static constexpr Tagged_t kscript_string = 0x5159;
  static constexpr Tagged_t ksecond_string = 0x516d;
  static constexpr Tagged_t kseconds_string = 0x5181;
  static constexpr Tagged_t kshort_string = 0x5195;
  static constexpr Tagged_t kSet_string = 0x51a9;
  static constexpr Tagged_t ksentence_string = 0x51b9;
  static constexpr Tagged_t kset_space_string = 0x51cd;
  static constexpr Tagged_t kset_string = 0x51dd;
  static constexpr Tagged_t kSetIterator_string = 0x51ed;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x5205;
  static constexpr Tagged_t kShadowRealm_string = 0x5221;
  static constexpr Tagged_t kSharedArray_string = 0x5239;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x5251;
  static constexpr Tagged_t kSharedStruct_string = 0x5271;
  static constexpr Tagged_t ksign_string = 0x5289;
  static constexpr Tagged_t ksize_string = 0x5299;
  static constexpr Tagged_t ksmallestUnit_string = 0x52a9;
  static constexpr Tagged_t ksource_string = 0x52c1;
  static constexpr Tagged_t ksourceText_string = 0x52d5;
  static constexpr Tagged_t kstack_string = 0x52ed;
  static constexpr Tagged_t kstackTraceLimit_string = 0x5301;
  static constexpr Tagged_t kstatic_initializer_string = 0x531d;
  static constexpr Tagged_t ksticky_string = 0x533d;
  static constexpr Tagged_t kString_string = 0x5351;
  static constexpr Tagged_t kstring_string = 0x5365;
  static constexpr Tagged_t kstring_to_string = 0x5379;
  static constexpr Tagged_t ksuppressed_string = 0x5395;
  static constexpr Tagged_t kSuppressedError_string = 0x53ad;
  static constexpr Tagged_t kSuspendError_string = 0x53c9;
  static constexpr Tagged_t kSymbol_iterator_string = 0x53e1;
  static constexpr Tagged_t kSymbol_match_all_string = 0x53fd;
  static constexpr Tagged_t kSymbol_replace_string = 0x5419;
  static constexpr Tagged_t ksymbol_species_string = 0x5435;
  static constexpr Tagged_t kSymbol_species_string = 0x5451;
  static constexpr Tagged_t kSymbol_split_string = 0x546d;
  static constexpr Tagged_t kSymbol_string = 0x5485;
  static constexpr Tagged_t ksymbol_string = 0x5499;
  static constexpr Tagged_t kSyntaxError_string = 0x54ad;
  static constexpr Tagged_t ktarget_string = 0x54c5;
  static constexpr Tagged_t kthis_function_string = 0x54d9;
  static constexpr Tagged_t kthis_string = 0x54f5;
  static constexpr Tagged_t kthrow_string = 0x5505;
  static constexpr Tagged_t ktimed_out_string = 0x5519;
  static constexpr Tagged_t ktimeZone_string = 0x5531;
  static constexpr Tagged_t ktimeZoneId_string = 0x5545;
  static constexpr Tagged_t ktimeZoneName_string = 0x555d;
  static constexpr Tagged_t ktoJSON_string = 0x5575;
  static constexpr Tagged_t ktoString_string = 0x5589;
  static constexpr Tagged_t ktrue_string = 0x559d;
  static constexpr Tagged_t ktotal_string = 0x55ad;
  static constexpr Tagged_t kTypedArrayLength_string = 0x55c1;
  static constexpr Tagged_t kTypeError_string = 0x55ed;
  static constexpr Tagged_t kUint16Array_string = 0x5605;
  static constexpr Tagged_t kUint32Array_string = 0x561d;
  static constexpr Tagged_t kUint8Array_string = 0x5635;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x564d;
  static constexpr Tagged_t kundefined_string = 0x566d;
  static constexpr Tagged_t kundefined_to_string = 0x5685;
  static constexpr Tagged_t kunicode_string = 0x56a5;
  static constexpr Tagged_t kunicodeSets_string = 0x56b9;
  static constexpr Tagged_t kunit_string = 0x56d1;
  static constexpr Tagged_t kURIError_string = 0x56e1;
  static constexpr Tagged_t kUTC_string = 0x56f5;
  static constexpr Tagged_t kWeakMap_string = 0x5705;
  static constexpr Tagged_t kWeakRef_string = 0x5719;
  static constexpr Tagged_t kWeakSet_string = 0x572d;
  static constexpr Tagged_t kweek_string = 0x5741;
  static constexpr Tagged_t kweeks_string = 0x5751;
  static constexpr Tagged_t kweekOfYear_string = 0x5765;
  static constexpr Tagged_t kwith_string = 0x577d;
  static constexpr Tagged_t kword_string = 0x578d;
  static constexpr Tagged_t kwritten_string = 0x579d;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x57b1;
  static constexpr Tagged_t kyear_string = 0x57d1;
  static constexpr Tagged_t kyears_string = 0x57e1;
  static constexpr Tagged_t kyearOfWeek_string = 0x57f5;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x580d;
  static constexpr Tagged_t kcall_site_info_symbol = 0x581d;
  static constexpr Tagged_t kclass_fields_symbol = 0x582d;
  static constexpr Tagged_t kclass_positions_symbol = 0x583d;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x584d;
  static constexpr Tagged_t kerror_message_symbol = 0x585d;
  static constexpr Tagged_t kerror_script_symbol = 0x586d;
  static constexpr Tagged_t kerror_stack_symbol = 0x587d;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x588d;
  static constexpr Tagged_t kfrozen_symbol = 0x589d;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x58ad;
  static constexpr Tagged_t knative_context_index_symbol = 0x58bd;
  static constexpr Tagged_t knonextensible_symbol = 0x58cd;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x58dd;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x58ed;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x58fd;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x590d;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x591d;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x592d;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x593d;
  static constexpr Tagged_t ksealed_symbol = 0x594d;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x595d;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x596d;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x597d;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x598d;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x599d;
  static constexpr Tagged_t kwasm_asm_single_function_symbol = 0x59ad;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x59bd;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x59cd;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x59dd;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x59ed;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x59fd;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x5a0d;
  static constexpr Tagged_t kasync_iterator_symbol = 0x5a1d;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5a4d;
  static constexpr Tagged_t kmatch_symbol = 0x5a85;
  static constexpr Tagged_t ksearch_symbol = 0x5aad;
  static constexpr Tagged_t kunscopables_symbol = 0x5ad9;
  static constexpr Tagged_t kdispose_symbol = 0x5b09;
  static constexpr Tagged_t kasync_dispose_symbol = 0x5b35;
  static constexpr Tagged_t khas_instance_symbol = 0x5b65;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5b95;
  static constexpr Tagged_t kconstructor_string = 0x5c0d;
  static constexpr Tagged_t knext_string = 0x5c25;
  static constexpr Tagged_t kresolve_string = 0x5c35;
  static constexpr Tagged_t kthen_string = 0x5c49;
  static constexpr Tagged_t kvalueOf_string = 0x5c59;
  static constexpr Tagged_t kiterator_symbol = 0x5c6d;
  static constexpr Tagged_t kmatch_all_symbol = 0x5c7d;
  static constexpr Tagged_t kreplace_symbol = 0x5c8d;
  static constexpr Tagged_t kspecies_symbol = 0x5c9d;
  static constexpr Tagged_t ksplit_symbol = 0x5cad;
  static constexpr Tagged_t kto_primitive_symbol = 0x5cbd;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x5ccd;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x5cdd;
  static constexpr Tagged_t kEmptySymbolTable = 0x5d01;
  static constexpr Tagged_t kUndefinedContextCell = 0x5d1d;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x5d35;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x5d49;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x5d5d;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x5d69;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x5d89;
  static constexpr Tagged_t kNativeScopeInfo = 0x5dad;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x5dc5;
  static constexpr Tagged_t kManyClosuresCell = 0x5ddd;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x5ded;
  static constexpr Tagged_t kTheHoleValue = 0x6525;
  static constexpr Tagged_t kPropertyCellHoleValue = 0x6529;
  static constexpr Tagged_t kHashTableHoleValue = 0x652d;
  static constexpr Tagged_t kPromiseHoleValue = 0x6531;
  static constexpr Tagged_t kUninitializedValue = 0x6535;
  static constexpr Tagged_t kArgumentsMarker = 0x6539;
  static constexpr Tagged_t kTerminationException = 0x653d;
  static constexpr Tagged_t kException = 0x6541;
  static constexpr Tagged_t kOptimizedOut = 0x6545;
  static constexpr Tagged_t kStaleRegister = 0x6549;
  static constexpr Tagged_t kSelfReferenceMarker = 0x654d;
  static constexpr Tagged_t kBasicBlockCountersMarker = 0x6551;
  static constexpr Tagged_t kJSMessageObjectMap = 0x6555;
  static constexpr Tagged_t kExternalMap = 0x657d;
  static constexpr Tagged_t kCppHeapExternalMap = 0x65a5;
  static constexpr Tagged_t kJSSharedArrayMap = 0x65cd;
  static constexpr Tagged_t kJSAtomicsMutexMap = 0x6615;
  static constexpr Tagged_t kJSAtomicsConditionMap = 0x663d;
  static constexpr Tagged_t kNoOpInterceptorInfo = 0x6665;

  static constexpr Tagged_t kFirstAllocatedRoot = 0x11;
  static constexpr Tagged_t kLastAllocatedRoot = 0x6665;
};
