...
struct StaticReadOnlyRoot {
  ...
  static constexpr Tagged_t kascii_nul_string = 0x2235;
  static constexpr Tagged_t kascii_soh_string = 0x2245;
  static constexpr Tagged_t kascii_stx_string = 0x2255;
  static constexpr Tagged_t kascii_etx_string = 0x2265;
  static constexpr Tagged_t kascii_eot_string = 0x2275;
  static constexpr Tagged_t kascii_enq_string = 0x2285;
  static constexpr Tagged_t kascii_ack_string = 0x2295;
  static constexpr Tagged_t kascii_bel_string = 0x22a5;
  static constexpr Tagged_t kascii_bs_string = 0x22b5;
  static constexpr Tagged_t kascii_ht_string = 0x22c5;
  static constexpr Tagged_t kascii_lf_string = 0x22d5;
  static constexpr Tagged_t kascii_vt_string = 0x22e5;
  static constexpr Tagged_t kascii_ff_string = 0x22f5;
  static constexpr Tagged_t kascii_cr_string = 0x2305;
  static constexpr Tagged_t kascii_so_string = 0x2315;
  static constexpr Tagged_t kascii_si_string = 0x2325;
  static constexpr Tagged_t kascii_dle_string = 0x2335;
  static constexpr Tagged_t kascii_dc1_string = 0x2345;
  static constexpr Tagged_t kascii_dc2_string = 0x2355;
  static constexpr Tagged_t kascii_dc3_string = 0x2365;
  static constexpr Tagged_t kascii_dc4_string = 0x2375;
  static constexpr Tagged_t kascii_nak_string = 0x2385;
  static constexpr Tagged_t kascii_syn_string = 0x2395;
  static constexpr Tagged_t kascii_etb_string = 0x23a5;
  static constexpr Tagged_t kascii_can_string = 0x23b5;
  static constexpr Tagged_t kascii_em_string = 0x23c5;
  static constexpr Tagged_t kascii_sub_string = 0x23d5;
  static constexpr Tagged_t kascii_esc_string = 0x23e5;
  static constexpr Tagged_t kascii_fs_string = 0x23f5;
  static constexpr Tagged_t kascii_gs_string = 0x2405;
  static constexpr Tagged_t kascii_rs_string = 0x2415;
  static constexpr Tagged_t kascii_us_string = 0x2425;
  static constexpr Tagged_t kspace_string = 0x2435;
  static constexpr Tagged_t kexclamation_mark_string = 0x2445;
  static constexpr Tagged_t kdouble_quotes_string = 0x2455;
  static constexpr Tagged_t khash_string = 0x2465;
  static constexpr Tagged_t kdollar_string = 0x2475;
  static constexpr Tagged_t kpercent_sign_string = 0x2485;
  static constexpr Tagged_t kampersand_string = 0x2495;
  static constexpr Tagged_t ksingle_quote_string = 0x24a5;
  static constexpr Tagged_t kopen_parenthesis_string = 0x24b5;
  static constexpr Tagged_t kclose_parenthesis_string = 0x24c5;
  static constexpr Tagged_t kasterisk_string = 0x24d5;
  static constexpr Tagged_t kplus_string = 0x24e5;
  static constexpr Tagged_t kcomma_string = 0x24f5;
  static constexpr Tagged_t kminus_string = 0x2505;
  static constexpr Tagged_t kdot_string = 0x2515;
  static constexpr Tagged_t kslash_string = 0x2525;
  static constexpr Tagged_t kzero_string = 0x2535;
  static constexpr Tagged_t kone_string = 0x2545;
  static constexpr Tagged_t ktwo_string = 0x2555;
  static constexpr Tagged_t kthree_string = 0x2565;
  static constexpr Tagged_t kfour_string = 0x2575;
  static constexpr Tagged_t kfive_string = 0x2585;
  static constexpr Tagged_t ksix_string = 0x2595;
  static constexpr Tagged_t kseven_string = 0x25a5;
  static constexpr Tagged_t keight_string = 0x25b5;
  static constexpr Tagged_t knine_string = 0x25c5;
  static constexpr Tagged_t kcolon_string = 0x25d5;
  static constexpr Tagged_t ksemicolon_string = 0x25e5;
  static constexpr Tagged_t kless_than_string = 0x25f5;
  static constexpr Tagged_t kequals_string = 0x2605;
  static constexpr Tagged_t kgreater_than_string = 0x2615;
  static constexpr Tagged_t kquestion_mark_string = 0x2625;
  static constexpr Tagged_t kat_sign_string = 0x2635;
  static constexpr Tagged_t kA_string = 0x2645;
  static constexpr Tagged_t kB_string = 0x2655;
  static constexpr Tagged_t kC_string = 0x2665;
  static constexpr Tagged_t kD_string = 0x2675;
  static constexpr Tagged_t kE_string = 0x2685;
  static constexpr Tagged_t kF_string = 0x2695;
  static constexpr Tagged_t kG_string = 0x26a5;
  static constexpr Tagged_t kH_string = 0x26b5;
  static constexpr Tagged_t kI_string = 0x26c5;
  static constexpr Tagged_t kJ_string = 0x26d5;
  static constexpr Tagged_t kK_string = 0x26e5;
  static constexpr Tagged_t kL_string = 0x26f5;
  static constexpr Tagged_t kM_string = 0x2705;
  static constexpr Tagged_t kN_string = 0x2715;
  static constexpr Tagged_t kO_string = 0x2725;
  static constexpr Tagged_t kP_string = 0x2735;
  static constexpr Tagged_t kQ_string = 0x2745;
  static constexpr Tagged_t kR_string = 0x2755;
  static constexpr Tagged_t kS_string = 0x2765;
  static constexpr Tagged_t kT_string = 0x2775;
  static constexpr Tagged_t kU_string = 0x2785;
  static constexpr Tagged_t kV_string = 0x2795;
  static constexpr Tagged_t kW_string = 0x27a5;
  static constexpr Tagged_t kX_string = 0x27b5;
  static constexpr Tagged_t kY_string = 0x27c5;
  static constexpr Tagged_t kZ_string = 0x27d5;
  static constexpr Tagged_t kopen_bracket_string = 0x27e5;
  static constexpr Tagged_t kbackslash_string = 0x27f5;
  static constexpr Tagged_t kclose_bracket_string = 0x2805;
  static constexpr Tagged_t kcaret_string = 0x2815;
  static constexpr Tagged_t kunderscore_string = 0x2825;
  static constexpr Tagged_t kbacktick_string = 0x2835;
  static constexpr Tagged_t ka_string = 0x2845;
  static constexpr Tagged_t kb_string = 0x2855;
  static constexpr Tagged_t kc_string = 0x2865;
  static constexpr Tagged_t kd_string = 0x2875;
  static constexpr Tagged_t ke_string = 0x2885;
  static constexpr Tagged_t kf_string = 0x2895;
  static constexpr Tagged_t kg_string = 0x28a5;
  static constexpr Tagged_t kh_string = 0x28b5;
  static constexpr Tagged_t ki_string = 0x28c5;
  static constexpr Tagged_t kj_string = 0x28d5;
  static constexpr Tagged_t kk_string = 0x28e5;
  static constexpr Tagged_t kl_string = 0x28f5;
  static constexpr Tagged_t km_string = 0x2905;
  static constexpr Tagged_t kn_string = 0x2915;
  static constexpr Tagged_t ko_string = 0x2925;
  static constexpr Tagged_t kp_string = 0x2935;
  static constexpr Tagged_t kq_string = 0x2945;
  static constexpr Tagged_t kr_string = 0x2955;
  static constexpr Tagged_t ks_string = 0x2965;
  static constexpr Tagged_t kt_string = 0x2975;
  static constexpr Tagged_t ku_string = 0x2985;
  static constexpr Tagged_t kv_string = 0x2995;
  static constexpr Tagged_t kw_string = 0x29a5;
  static constexpr Tagged_t kx_string = 0x29b5;
  static constexpr Tagged_t ky_string = 0x29c5;
  static constexpr Tagged_t kz_string = 0x29d5;
  static constexpr Tagged_t kopen_brace_string = 0x29e5;
  static constexpr Tagged_t kpipe_string = 0x29f5;
  static constexpr Tagged_t kclose_brace_string = 0x2a05;
  static constexpr Tagged_t ktilde_string = 0x2a15;
  static constexpr Tagged_t kascii_del_string = 0x2a25;
  static constexpr Tagged_t klatin1_80_string = 0x2a35;
  static constexpr Tagged_t klatin1_81_string = 0x2a45;
  static constexpr Tagged_t klatin1_82_string = 0x2a55;
  static constexpr Tagged_t klatin1_83_string = 0x2a65;
  static constexpr Tagged_t klatin1_84_string = 0x2a75;
  static constexpr Tagged_t klatin1_85_string = 0x2a85;
  static constexpr Tagged_t klatin1_86_string = 0x2a95;
  static constexpr Tagged_t klatin1_87_string = 0x2aa5;
  static constexpr Tagged_t klatin1_88_string = 0x2ab5;
  static constexpr Tagged_t klatin1_89_string = 0x2ac5;
  static constexpr Tagged_t klatin1_8a_string = 0x2ad5;
  static constexpr Tagged_t klatin1_8b_string = 0x2ae5;
  static constexpr Tagged_t klatin1_8c_string = 0x2af5;
  static constexpr Tagged_t klatin1_8d_string = 0x2b05;
  static constexpr Tagged_t klatin1_8e_string = 0x2b15;
  static constexpr Tagged_t klatin1_8f_string = 0x2b25;
  static constexpr Tagged_t klatin1_90_string = 0x2b35;
  static constexpr Tagged_t klatin1_91_string = 0x2b45;
  static constexpr Tagged_t klatin1_92_string = 0x2b55;
  static constexpr Tagged_t klatin1_93_string = 0x2b65;
  static constexpr Tagged_t klatin1_94_string = 0x2b75;
  static constexpr Tagged_t klatin1_95_string = 0x2b85;
  static constexpr Tagged_t klatin1_96_string = 0x2b95;
  static constexpr Tagged_t klatin1_97_string = 0x2ba5;
  static constexpr Tagged_t klatin1_98_string = 0x2bb5;
  static constexpr Tagged_t klatin1_99_string = 0x2bc5;
  static constexpr Tagged_t klatin1_9a_string = 0x2bd5;
  static constexpr Tagged_t klatin1_9b_string = 0x2be5;
  static constexpr Tagged_t klatin1_9c_string = 0x2bf5;
  static constexpr Tagged_t klatin1_9d_string = 0x2c05;
  static constexpr Tagged_t klatin1_9e_string = 0x2c15;
  static constexpr Tagged_t klatin1_9f_string = 0x2c25;
  static constexpr Tagged_t klatin1_a0_string = 0x2c35;
  static constexpr Tagged_t klatin1_a1_string = 0x2c45;
  static constexpr Tagged_t klatin1_a2_string = 0x2c55;
  static constexpr Tagged_t klatin1_a3_string = 0x2c65;
  static constexpr Tagged_t klatin1_a4_string = 0x2c75;
  static constexpr Tagged_t klatin1_a5_string = 0x2c85;
  static constexpr Tagged_t klatin1_a6_string = 0x2c95;
  static constexpr Tagged_t klatin1_a7_string = 0x2ca5;
  static constexpr Tagged_t klatin1_a8_string = 0x2cb5;
  static constexpr Tagged_t klatin1_a9_string = 0x2cc5;
  static constexpr Tagged_t klatin1_aa_string = 0x2cd5;
  static constexpr Tagged_t klatin1_ab_string = 0x2ce5;
  static constexpr Tagged_t klatin1_ac_string = 0x2cf5;
  static constexpr Tagged_t klatin1_ad_string = 0x2d05;
  static constexpr Tagged_t klatin1_ae_string = 0x2d15;
  static constexpr Tagged_t klatin1_af_string = 0x2d25;
  static constexpr Tagged_t klatin1_b0_string = 0x2d35;
  static constexpr Tagged_t klatin1_b1_string = 0x2d45;
  static constexpr Tagged_t klatin1_b2_string = 0x2d55;
  static constexpr Tagged_t klatin1_b3_string = 0x2d65;
  static constexpr Tagged_t klatin1_b4_string = 0x2d75;
  static constexpr Tagged_t klatin1_b5_string = 0x2d85;
  static constexpr Tagged_t klatin1_b6_string = 0x2d95;
  static constexpr Tagged_t klatin1_b7_string = 0x2da5;
  static constexpr Tagged_t klatin1_b8_string = 0x2db5;
  static constexpr Tagged_t klatin1_b9_string = 0x2dc5;
  static constexpr Tagged_t klatin1_ba_string = 0x2dd5;
  static constexpr Tagged_t klatin1_bb_string = 0x2de5;
  static constexpr Tagged_t klatin1_bc_string = 0x2df5;
  static constexpr Tagged_t klatin1_bd_string = 0x2e05;
  static constexpr Tagged_t klatin1_be_string = 0x2e15;
  static constexpr Tagged_t klatin1_bf_string = 0x2e25;
  static constexpr Tagged_t klatin1_c0_string = 0x2e35;
  static constexpr Tagged_t klatin1_c1_string = 0x2e45;
  static constexpr Tagged_t klatin1_c2_string = 0x2e55;
  static constexpr Tagged_t klatin1_c3_string = 0x2e65;
  static constexpr Tagged_t klatin1_c4_string = 0x2e75;
  static constexpr Tagged_t klatin1_c5_string = 0x2e85;
  static constexpr Tagged_t klatin1_c6_string = 0x2e95;
  static constexpr Tagged_t klatin1_c7_string = 0x2ea5;
  static constexpr Tagged_t klatin1_c8_string = 0x2eb5;
  static constexpr Tagged_t klatin1_c9_string = 0x2ec5;
  static constexpr Tagged_t klatin1_ca_string = 0x2ed5;
  static constexpr Tagged_t klatin1_cb_string = 0x2ee5;
  static constexpr Tagged_t klatin1_cc_string = 0x2ef5;
  static constexpr Tagged_t klatin1_cd_string = 0x2f05;
  static constexpr Tagged_t klatin1_ce_string = 0x2f15;
  static constexpr Tagged_t klatin1_cf_string = 0x2f25;
  static constexpr Tagged_t klatin1_d0_string = 0x2f35;
  static constexpr Tagged_t klatin1_d1_string = 0x2f45;
  static constexpr Tagged_t klatin1_d2_string = 0x2f55;
  static constexpr Tagged_t klatin1_d3_string = 0x2f65;
  static constexpr Tagged_t klatin1_d4_string = 0x2f75;
  static constexpr Tagged_t klatin1_d5_string = 0x2f85;
  static constexpr Tagged_t klatin1_d6_string = 0x2f95;
  static constexpr Tagged_t klatin1_d7_string = 0x2fa5;
  static constexpr Tagged_t klatin1_d8_string = 0x2fb5;
  static constexpr Tagged_t klatin1_d9_string = 0x2fc5;
  static constexpr Tagged_t klatin1_da_string = 0x2fd5;
  static constexpr Tagged_t klatin1_db_string = 0x2fe5;
  static constexpr Tagged_t klatin1_dc_string = 0x2ff5;
  static constexpr Tagged_t klatin1_dd_string = 0x3005;
  static constexpr Tagged_t klatin1_de_string = 0x3015;
  static constexpr Tagged_t klatin1_df_string = 0x3025;
  static constexpr Tagged_t klatin1_e0_string = 0x3035;
  static constexpr Tagged_t klatin1_e1_string = 0x3045;
  static constexpr Tagged_t klatin1_e2_string = 0x3055;
  static constexpr Tagged_t klatin1_e3_string = 0x3065;
  static constexpr Tagged_t klatin1_e4_string = 0x3075;
  static constexpr Tagged_t klatin1_e5_string = 0x3085;
  static constexpr Tagged_t klatin1_e6_string = 0x3095;
  static constexpr Tagged_t klatin1_e7_string = 0x30a5;
  static constexpr Tagged_t klatin1_e8_string = 0x30b5;
  static constexpr Tagged_t klatin1_e9_string = 0x30c5;
  static constexpr Tagged_t klatin1_ea_string = 0x30d5;
  static constexpr Tagged_t klatin1_eb_string = 0x30e5;
  static constexpr Tagged_t klatin1_ec_string = 0x30f5;
  static constexpr Tagged_t klatin1_ed_string = 0x3105;
  static constexpr Tagged_t klatin1_ee_string = 0x3115;
  static constexpr Tagged_t klatin1_ef_string = 0x3125;
  static constexpr Tagged_t klatin1_f0_string = 0x3135;
  static constexpr Tagged_t klatin1_f1_string = 0x3145;
  static constexpr Tagged_t klatin1_f2_string = 0x3155;
  static constexpr Tagged_t klatin1_f3_string = 0x3165;
  static constexpr Tagged_t klatin1_f4_string = 0x3175;
  static constexpr Tagged_t klatin1_f5_string = 0x3185;
  static constexpr Tagged_t klatin1_f6_string = 0x3195;
  static constexpr Tagged_t klatin1_f7_string = 0x31a5;
  static constexpr Tagged_t klatin1_f8_string = 0x31b5;
  static constexpr Tagged_t klatin1_f9_string = 0x31c5;
  static constexpr Tagged_t klatin1_fa_string = 0x31d5;
  static constexpr Tagged_t klatin1_fb_string = 0x31e5;
  static constexpr Tagged_t klatin1_fc_string = 0x31f5;
  static constexpr Tagged_t klatin1_fd_string = 0x3205;
  static constexpr Tagged_t klatin1_fe_string = 0x3215;
  static constexpr Tagged_t klatin1_ff_string = 0x3225;
  static constexpr Tagged_t kadd_string = 0x3235;
  static constexpr Tagged_t kAggregateError_string = 0x3245;
  static constexpr Tagged_t kalphabet_string = 0x3261;
  static constexpr Tagged_t kalways_string = 0x3275;
  static constexpr Tagged_t kanonymous_string = 0x3289;
  static constexpr Tagged_t kapply_string = 0x32a1;
  static constexpr Tagged_t kArguments_string = 0x32b5;
  static constexpr Tagged_t karguments_string = 0x32cd;
  static constexpr Tagged_t karguments_to_string = 0x32e5;
  static constexpr Tagged_t kArray_string = 0x3305;
  static constexpr Tagged_t karray_to_string = 0x3319;
  static constexpr Tagged_t kArrayBuffer_string = 0x3335;
  static constexpr Tagged_t kArrayIterator_string = 0x334d;
  static constexpr Tagged_t kas_string = 0x3369;
  static constexpr Tagged_t kassert_string = 0x3379;
  static constexpr Tagged_t kasync_string = 0x338d;
  static constexpr Tagged_t kAtomicsCondition_string = 0x33a1;
  static constexpr Tagged_t kAtomicsMutex_string = 0x33c1;
  static constexpr Tagged_t kauto_string = 0x33dd;
  static constexpr Tagged_t kBigInt64Array_string = 0x33ed;
  static constexpr Tagged_t kBigInt_string = 0x3409;
  static constexpr Tagged_t kbigint_string = 0x341d;
  static constexpr Tagged_t kBigUint64Array_string = 0x3431;
  static constexpr Tagged_t kbind_string = 0x344d;
  static constexpr Tagged_t kblank_string = 0x345d;
  static constexpr Tagged_t kBoolean_string = 0x3471;
  static constexpr Tagged_t kboolean_string = 0x3485;
  static constexpr Tagged_t kboolean_to_string = 0x3499;
  static constexpr Tagged_t kbound__string = 0x34b5;
  static constexpr Tagged_t kbuffer_string = 0x34c9;
  static constexpr Tagged_t kbyte_length_string = 0x34dd;
  static constexpr Tagged_t kbyte_offset_string = 0x34f5;
  static constexpr Tagged_t kcalendar_string = 0x350d;
  static constexpr Tagged_t kcalendarId_string = 0x3521;
  static constexpr Tagged_t kcalendarName_string = 0x3539;
  static constexpr Tagged_t kcallee_string = 0x3551;
  static constexpr Tagged_t kcaller_string = 0x3565;
  static constexpr Tagged_t kcause_string = 0x3579;
  static constexpr Tagged_t kcharacter_string = 0x358d;
  static constexpr Tagged_t kcode_string = 0x35a5;
  static constexpr Tagged_t kcolumn_string = 0x35b5;
  static constexpr Tagged_t kCompileError_string = 0x35c9;
  static constexpr Tagged_t kcomputed_string = 0x35e1;
  static constexpr Tagged_t kconjunction_string = 0x35f9;
  static constexpr Tagged_t kconsole_string = 0x3611;
  static constexpr Tagged_t kconstrain_string = 0x3625;
  static constexpr Tagged_t kconstruct_string = 0x363d;
  static constexpr Tagged_t kcurrent_string = 0x3655;
  static constexpr Tagged_t kDate_string = 0x3669;
  static constexpr Tagged_t kdate_to_string = 0x3679;
  static constexpr Tagged_t kdateAdd_string = 0x3695;
  static constexpr Tagged_t kdateFromFields_string = 0x36a9;
  static constexpr Tagged_t kdateUntil_string = 0x36c5;
  static constexpr Tagged_t kday_string = 0x36dd;
  static constexpr Tagged_t kdayOfWeek_string = 0x36ed;
  static constexpr Tagged_t kdayOfYear_string = 0x3705;
  static constexpr Tagged_t kdays_string = 0x371d;
  static constexpr Tagged_t kdaysInMonth_string = 0x372d;
  static constexpr Tagged_t kdaysInWeek_string = 0x3745;
  static constexpr Tagged_t kdaysInYear_string = 0x375d;
  static constexpr Tagged_t kdefault_string = 0x3775;
  static constexpr Tagged_t kdefer_string = 0x3789;
  static constexpr Tagged_t kdefineProperty_string = 0x379d;
  static constexpr Tagged_t kdeleteProperty_string = 0x37b9;
  static constexpr Tagged_t kdetached_string = 0x37d5;
  static constexpr Tagged_t kdirection_string = 0x37e9;
  static constexpr Tagged_t kdisambiguation_string = 0x3801;
  static constexpr Tagged_t kdisjunction_string = 0x381d;
  static constexpr Tagged_t kdisposed_string = 0x3835;
  static constexpr Tagged_t kdone_string = 0x3849;
  static constexpr Tagged_t kdot_brand_string = 0x3859;
  static constexpr Tagged_t kdot_catch_string = 0x386d;
  static constexpr Tagged_t kdot_default_string = 0x3881;
  static constexpr Tagged_t kdot_for_string = 0x3895;
  static constexpr Tagged_t kdot_generator_object_string = 0x38a5;
  static constexpr Tagged_t kdot_home_object_string = 0x38c5;
  static constexpr Tagged_t kdot_new_target_string = 0x38dd;
  static constexpr Tagged_t kdot_repl_result_string = 0x38f5;
  static constexpr Tagged_t kdot_result_string = 0x390d;
  static constexpr Tagged_t kdot_static_home_object_string = 0x3921;
  static constexpr Tagged_t kdot_switch_tag_string = 0x3941;
  static constexpr Tagged_t kdot_this_function_string = 0x3959;
  static constexpr Tagged_t kdotAll_string = 0x3975;
  static constexpr Tagged_t kelement_string = 0x3989;
  static constexpr Tagged_t kepochMilliseconds_string = 0x399d;
  static constexpr Tagged_t kepochNanoseconds_string = 0x39bd;
  static constexpr Tagged_t kera_string = 0x39d9;
  static constexpr Tagged_t keraYear_string = 0x39e9;
  static constexpr Tagged_t kError_string = 0x39fd;
  static constexpr Tagged_t kerror_string = 0x3a11;
  static constexpr Tagged_t kerror_to_string = 0x3a25;
  static constexpr Tagged_t kerrors_string = 0x3a41;
  static constexpr Tagged_t keval_string = 0x3a55;
  static constexpr Tagged_t kEvalError_string = 0x3a65;
  static constexpr Tagged_t kexception_string = 0x3a7d;
  static constexpr Tagged_t kexec_string = 0x3a95;
  static constexpr Tagged_t kfalse_string = 0x3aa5;
  static constexpr Tagged_t kfields_string = 0x3ab9;
  static constexpr Tagged_t kFinalizationRegistry_string = 0x3acd;
  static constexpr Tagged_t kflags_string = 0x3aed;
  static constexpr Tagged_t kFloat16Array_string = 0x3b01;
  static constexpr Tagged_t kFloat32Array_string = 0x3b19;
  static constexpr Tagged_t kFloat64Array_string = 0x3b31;
  static constexpr Tagged_t kfractionalSecondDigits_string = 0x3b49;
  static constexpr Tagged_t kfrom_string = 0x3b6d;
  static constexpr Tagged_t kfunction_native_code_string = 0x3b7d;
  static constexpr Tagged_t kFunction_prototype_apply_string = 0x3ba9;
  static constexpr Tagged_t kFunction_prototype_call_string = 0x3bcd;
  static constexpr Tagged_t kFunction_string = 0x3bf1;
  static constexpr Tagged_t kfunction_string = 0x3c05;
  static constexpr Tagged_t kfunction_to_string = 0x3c19;
  static constexpr Tagged_t kGenerator_string = 0x3c39;
  static constexpr Tagged_t kget_space_string = 0x3c51;
  static constexpr Tagged_t kget_string = 0x3c61;
  static constexpr Tagged_t kgetOffsetNanosecondsFor_string = 0x3c71;
  static constexpr Tagged_t kgetOwnPropertyDescriptor_string = 0x3c95;
  static constexpr Tagged_t kgetPossibleInstantsFor_string = 0x3cb9;
  static constexpr Tagged_t kgetPrototypeOf_string = 0x3cdd;
  static constexpr Tagged_t kgetTimeZoneTransition_string = 0x3cf9;
  static constexpr Tagged_t kglobal_string = 0x3d1d;
  static constexpr Tagged_t kglobalThis_string = 0x3d31;
  static constexpr Tagged_t kgroups_string = 0x3d49;
  static constexpr Tagged_t kgrowable_string = 0x3d5d;
  static constexpr Tagged_t khas_string = 0x3d71;
  static constexpr Tagged_t khasIndices_string = 0x3d81;
  static constexpr Tagged_t khour_string = 0x3d99;
  static constexpr Tagged_t khours_string = 0x3da9;
  static constexpr Tagged_t khoursInDay_string = 0x3dbd;
  static constexpr Tagged_t kid_string = 0x3dd5;
  static constexpr Tagged_t kignoreCase_string = 0x3de5;
  static constexpr Tagged_t killegal_access_string = 0x3dfd;
  static constexpr Tagged_t killegal_argument_string = 0x3e19;
  static constexpr Tagged_t kimmutable_string = 0x3e35;
  static constexpr Tagged_t kindex_string = 0x3e4d;
  static constexpr Tagged_t kindices_string = 0x3e61;
  static constexpr Tagged_t kInfinity_string = 0x3e75;
  static constexpr Tagged_t kinfinity_string = 0x3e89;
  static constexpr Tagged_t kinLeapYear_string = 0x3e9d;
  static constexpr Tagged_t kinput_string = 0x3eb5;
  static constexpr Tagged_t kinstance_members_initializer_string = 0x3ec9;
  static constexpr Tagged_t kInt16Array_string = 0x3ef5;
  static constexpr Tagged_t kInt32Array_string = 0x3f0d;
  static constexpr Tagged_t kInt8Array_string = 0x3f25;
  static constexpr Tagged_t kisExtensible_string = 0x3f3d;
  static constexpr Tagged_t kiso8601_string = 0x3f55;
  static constexpr Tagged_t kisoDay_string = 0x3f69;
  static constexpr Tagged_t kisoHour_string = 0x3f7d;
  static constexpr Tagged_t kisoMicrosecond_string = 0x3f91;
  static constexpr Tagged_t kisoMillisecond_string = 0x3fad;
  static constexpr Tagged_t kisoMinute_string = 0x3fc9;
  static constexpr Tagged_t kisoMonth_string = 0x3fe1;
  static constexpr Tagged_t kisoNanosecond_string = 0x3ff5;
  static constexpr Tagged_t kisoSecond_string = 0x4011;
  static constexpr Tagged_t kisoYear_string = 0x4029;
  static constexpr Tagged_t kIterator_string = 0x403d;
  static constexpr Tagged_t kjsMemoryEstimate_string = 0x4051;
  static constexpr Tagged_t kjsMemoryRange_string = 0x406d;
  static constexpr Tagged_t kkeys_string = 0x4089;
  static constexpr Tagged_t klargestUnit_string = 0x4099;
  static constexpr Tagged_t klast_chunk_handling_string = 0x40b1;
  static constexpr Tagged_t klastIndex_string = 0x40d1;
  static constexpr Tagged_t klet_string = 0x40e9;
  static constexpr Tagged_t kline_string = 0x40f9;
  static constexpr Tagged_t klinear_string = 0x4109;
  static constexpr Tagged_t kLinkError_string = 0x411d;
  static constexpr Tagged_t klong_string = 0x4135;
  static constexpr Tagged_t kMap_string = 0x4145;
  static constexpr Tagged_t kMapIterator_string = 0x4155;
  static constexpr Tagged_t kmax_byte_length_string = 0x416d;
  static constexpr Tagged_t kmedium_string = 0x4189;
  static constexpr Tagged_t kmergeFields_string = 0x419d;
  static constexpr Tagged_t kmessage_string = 0x41b5;
  static constexpr Tagged_t kmeta_string = 0x41c9;
  static constexpr Tagged_t kmicrosecond_string = 0x41d9;
  static constexpr Tagged_t kmicroseconds_string = 0x41f1;
  static constexpr Tagged_t kmillisecond_string = 0x4209;
  static constexpr Tagged_t kmilliseconds_string = 0x4221;
  static constexpr Tagged_t kminus_Infinity_string = 0x4239;
  static constexpr Tagged_t kminute_string = 0x4251;
  static constexpr Tagged_t kminutes_string = 0x4265;
  static constexpr Tagged_t kModule_string = 0x4279;
  static constexpr Tagged_t kmonth_string = 0x428d;
  static constexpr Tagged_t kmonthCode_string = 0x42a1;
  static constexpr Tagged_t kmonthDayFromFields_string = 0x42b9;
  static constexpr Tagged_t kmonths_string = 0x42d9;
  static constexpr Tagged_t kmonthsInYear_string = 0x42ed;
  static constexpr Tagged_t kmultiline_string = 0x4305;
  static constexpr Tagged_t kNaN_string = 0x431d;
  static constexpr Tagged_t knanosecond_string = 0x432d;
  static constexpr Tagged_t knanoseconds_string = 0x4345;
  static constexpr Tagged_t knarrow_string = 0x435d;
  static constexpr Tagged_t knative_string = 0x4371;
  static constexpr Tagged_t kNFC_string = 0x4385;
  static constexpr Tagged_t kNFD_string = 0x4395;
  static constexpr Tagged_t kNFKC_string = 0x43a5;
  static constexpr Tagged_t kNFKD_string = 0x43b5;
  static constexpr Tagged_t knot_equal_string = 0x43c5;
  static constexpr Tagged_t knull_string = 0x43dd;
  static constexpr Tagged_t knull_to_string = 0x43ed;
  static constexpr Tagged_t kNumber_string = 0x4409;
  static constexpr Tagged_t knumber_string = 0x441d;
  static constexpr Tagged_t knumber_to_string = 0x4431;
  static constexpr Tagged_t kObject_prototype_string = 0x444d;
  static constexpr Tagged_t kObject_string = 0x4469;
  static constexpr Tagged_t kobject_string = 0x447d;
  static constexpr Tagged_t kobject_to_string = 0x4491;
  static constexpr Tagged_t koffset_string = 0x44ad;
  static constexpr Tagged_t koffsetNanoseconds_string = 0x44c1;
  static constexpr Tagged_t kok_string = 0x44e1;
  static constexpr Tagged_t kother_string = 0x44f1;
  static constexpr Tagged_t koverflow_string = 0x4505;
  static constexpr Tagged_t kownKeys_string = 0x4519;
  static constexpr Tagged_t kpercent_string = 0x452d;
  static constexpr Tagged_t kplainDate_string = 0x4541;
  static constexpr Tagged_t kplainTime_string = 0x4559;
  static constexpr Tagged_t kposition_string = 0x4571;
  static constexpr Tagged_t kpreventExtensions_string = 0x4585;
  static constexpr Tagged_t kprivate_constructor_string = 0x45a5;
  static constexpr Tagged_t kPromise_string = 0x45bd;
  static constexpr Tagged_t kpromise_string = 0x45d1;
  static constexpr Tagged_t kproto_string = 0x45e5;
  static constexpr Tagged_t kproxy_string = 0x45fd;
  static constexpr Tagged_t kProxy_string = 0x4611;
  static constexpr Tagged_t kquery_colon_string = 0x4625;
  static constexpr Tagged_t kRangeError_string = 0x4635;
  static constexpr Tagged_t kraw_json_string = 0x464d;
  static constexpr Tagged_t kraw_string = 0x4661;
  static constexpr Tagged_t kread_string = 0x4671;
  static constexpr Tagged_t kReferenceError_string = 0x4681;
  static constexpr Tagged_t kReflectGet_string = 0x469d;
  static constexpr Tagged_t kReflectHas_string = 0x46b5;
  static constexpr Tagged_t kRegExp_string = 0x46cd;
  static constexpr Tagged_t kregexp_to_string = 0x46e1;
  static constexpr Tagged_t kreject_string = 0x46fd;
  static constexpr Tagged_t krelativeTo_string = 0x4711;
  static constexpr Tagged_t kresizable_string = 0x4729;
  static constexpr Tagged_t kResizableArrayBuffer_string = 0x4741;
  static constexpr Tagged_t kreturn_string = 0x4761;
  static constexpr Tagged_t krevoke_string = 0x4775;
  static constexpr Tagged_t kroundingIncrement_string = 0x4789;
  static constexpr Tagged_t kroundingMode_string = 0x47a9;
  static constexpr Tagged_t kRuntimeError_string = 0x47c1;
  static constexpr Tagged_t kScript_string = 0x47d9;
  static constexpr Tagged_t kscript_string = 0x47ed;
  static constexpr Tagged_t ksecond_string = 0x4801;
  static constexpr Tagged_t kseconds_string = 0x4815;
  static constexpr Tagged_t ksentence_string = 0x4829;
  static constexpr Tagged_t kset_space_string = 0x483d;
  static constexpr Tagged_t kSet_string = 0x484d;
  static constexpr Tagged_t kset_string = 0x485d;
  static constexpr Tagged_t kSetIterator_string = 0x486d;
  static constexpr Tagged_t ksetPrototypeOf_string = 0x4885;
  static constexpr Tagged_t kShadowRealm_string = 0x48a1;
  static constexpr Tagged_t kSharedArray_string = 0x48b9;
  static constexpr Tagged_t kSharedArrayBuffer_string = 0x48d1;
  static constexpr Tagged_t kSharedStruct_string = 0x48f1;
  static constexpr Tagged_t kshort_string = 0x4909;
  static constexpr Tagged_t ksign_string = 0x491d;
  static constexpr Tagged_t ksize_string = 0x492d;
  static constexpr Tagged_t ksmallestUnit_string = 0x493d;
  static constexpr Tagged_t ksource_string = 0x4955;
  static constexpr Tagged_t ksourceText_string = 0x4969;
  static constexpr Tagged_t kstack_string = 0x4981;
  static constexpr Tagged_t kstackTraceLimit_string = 0x4995;
  static constexpr Tagged_t kstatic_initializer_string = 0x49b1;
  static constexpr Tagged_t ksticky_string = 0x49d1;
  static constexpr Tagged_t kString_string = 0x49e5;
  static constexpr Tagged_t kstring_string = 0x49f9;
  static constexpr Tagged_t kstring_to_string = 0x4a0d;
  static constexpr Tagged_t ksuppressed_string = 0x4a29;
  static constexpr Tagged_t kSuppressedError_string = 0x4a41;
  static constexpr Tagged_t kSuspendError_string = 0x4a5d;
  static constexpr Tagged_t kSymbol_iterator_string = 0x4a75;
  static constexpr Tagged_t kSymbol_match_all_string = 0x4a91;
  static constexpr Tagged_t kSymbol_replace_string = 0x4aad;
  static constexpr Tagged_t ksymbol_species_string = 0x4ac9;
  static constexpr Tagged_t kSymbol_species_string = 0x4ae5;
  static constexpr Tagged_t kSymbol_split_string = 0x4b01;
  static constexpr Tagged_t kSymbol_string = 0x4b19;
  static constexpr Tagged_t ksymbol_string = 0x4b2d;
  static constexpr Tagged_t kSyntaxError_string = 0x4b41;
  static constexpr Tagged_t ktarget_string = 0x4b59;
  static constexpr Tagged_t kthis_string = 0x4b6d;
  static constexpr Tagged_t kthrow_string = 0x4b7d;
  static constexpr Tagged_t ktimed_out_string = 0x4b91;
  static constexpr Tagged_t ktimeZone_string = 0x4ba9;
  static constexpr Tagged_t ktimeZoneId_string = 0x4bbd;
  static constexpr Tagged_t ktimeZoneName_string = 0x4bd5;
  static constexpr Tagged_t ktoJSON_string = 0x4bed;
  static constexpr Tagged_t ktoString_string = 0x4c01;
  static constexpr Tagged_t ktotal_string = 0x4c15;
  static constexpr Tagged_t ktrue_string = 0x4c29;
  static constexpr Tagged_t kTypedArrayLength_string = 0x4c39;
  static constexpr Tagged_t kTypeError_string = 0x4c65;
  static constexpr Tagged_t kUint16Array_string = 0x4c7d;
  static constexpr Tagged_t kUint32Array_string = 0x4c95;
  static constexpr Tagged_t kUint8Array_string = 0x4cad;
  static constexpr Tagged_t kUint8ClampedArray_string = 0x4cc5;
  static constexpr Tagged_t kundefined_string = 0x4ce5;
  static constexpr Tagged_t kundefined_to_string = 0x4cfd;
  static constexpr Tagged_t kunicode_string = 0x4d1d;
  static constexpr Tagged_t kunicodeSets_string = 0x4d31;
  static constexpr Tagged_t kunit_string = 0x4d49;
  static constexpr Tagged_t kURIError_string = 0x4d59;
  static constexpr Tagged_t kUTC_string = 0x4d6d;
  static constexpr Tagged_t kWeakMap_string = 0x4d7d;
  static constexpr Tagged_t kWeakRef_string = 0x4d91;
  static constexpr Tagged_t kWeakSet_string = 0x4da5;
  static constexpr Tagged_t kWebAssemblyException_string = 0x4db9;
  static constexpr Tagged_t kWebAssemblyModule_string = 0x4ddd;
  static constexpr Tagged_t kweek_string = 0x4dfd;
  static constexpr Tagged_t kweekOfYear_string = 0x4e0d;
  static constexpr Tagged_t kweeks_string = 0x4e25;
  static constexpr Tagged_t kwith_string = 0x4e39;
  static constexpr Tagged_t kword_string = 0x4e49;
  static constexpr Tagged_t kwritten_string = 0x4e59;
  static constexpr Tagged_t kyear_string = 0x4e6d;
  static constexpr Tagged_t kyearMonthFromFields_string = 0x4e7d;
  static constexpr Tagged_t kyearOfWeek_string = 0x4e9d;
  static constexpr Tagged_t kyears_string = 0x4eb5;
  static constexpr Tagged_t karray_buffer_wasm_memory_symbol = 0x4ec9;
  static constexpr Tagged_t kcall_site_info_symbol = 0x4ed9;
  static constexpr Tagged_t kclass_fields_symbol = 0x4ee9;
  static constexpr Tagged_t kclass_positions_symbol = 0x4ef9;
  static constexpr Tagged_t kerror_end_pos_symbol = 0x4f09;
  static constexpr Tagged_t kerror_message_symbol = 0x4f19;
  static constexpr Tagged_t kerror_script_symbol = 0x4f29;
  static constexpr Tagged_t kerror_stack_symbol = 0x4f39;
  static constexpr Tagged_t kerror_start_pos_symbol = 0x4f49;
  static constexpr Tagged_t kfrozen_symbol = 0x4f59;
  static constexpr Tagged_t kinterpreter_trampoline_symbol = 0x4f69;
  static constexpr Tagged_t knative_context_index_symbol = 0x4f79;
  static constexpr Tagged_t knonextensible_symbol = 0x4f89;
  static constexpr Tagged_t kpromise_debug_message_symbol = 0x4f99;
  static constexpr Tagged_t kpromise_forwarding_handler_symbol = 0x4fa9;
  static constexpr Tagged_t kpromise_handled_by_symbol = 0x4fb9;
  static constexpr Tagged_t kpromise_awaited_by_symbol = 0x4fc9;
  static constexpr Tagged_t kregexp_result_names_symbol = 0x4fd9;
  static constexpr Tagged_t kregexp_result_regexp_input_symbol = 0x4fe9;
  static constexpr Tagged_t kregexp_result_regexp_last_index_symbol = 0x4ff9;
  static constexpr Tagged_t ksealed_symbol = 0x5009;
  static constexpr Tagged_t kshared_struct_map_elements_template_symbol =
      0x5019;
  static constexpr Tagged_t kshared_struct_map_registry_key_symbol = 0x5029;
  static constexpr Tagged_t kstrict_function_transition_symbol = 0x5039;
  static constexpr Tagged_t ktemplate_literal_function_literal_id_symbol =
      0x5049;
  static constexpr Tagged_t ktemplate_literal_slot_id_symbol = 0x5059;
  static constexpr Tagged_t kwasm_asm_single_function_symbol = 0x5069;
  static constexpr Tagged_t kwasm_cross_instance_call_symbol = 0x5079;
  static constexpr Tagged_t kwasm_exception_tag_symbol = 0x5089;
  static constexpr Tagged_t kwasm_exception_values_symbol = 0x5099;
  static constexpr Tagged_t kwasm_uncatchable_symbol = 0x50a9;
  static constexpr Tagged_t kwasm_debug_proxy_cache_symbol = 0x50b9;
  static constexpr Tagged_t kwasm_debug_proxy_names_symbol = 0x50c9;
  static constexpr Tagged_t kasync_iterator_symbol = 0x50d9;
  static constexpr Tagged_t kintl_fallback_symbol = 0x5109;
  static constexpr Tagged_t kmatch_symbol = 0x5141;
  static constexpr Tagged_t ksearch_symbol = 0x5169;
  static constexpr Tagged_t kunscopables_symbol = 0x5195;
  static constexpr Tagged_t kdispose_symbol = 0x51c5;
  static constexpr Tagged_t kasync_dispose_symbol = 0x51f1;
  static constexpr Tagged_t khas_instance_symbol = 0x5221;
  static constexpr Tagged_t kto_string_tag_symbol = 0x5251;
  static constexpr Tagged_t kconstructor_string = 0x52c9;
  static constexpr Tagged_t knext_string = 0x52e1;
  static constexpr Tagged_t kresolve_string = 0x52f1;
  static constexpr Tagged_t kthen_string = 0x5305;
  static constexpr Tagged_t kvalueOf_string = 0x5315;
  static constexpr Tagged_t kiterator_symbol = 0x5329;
  static constexpr Tagged_t kmatch_all_symbol = 0x5339;
  static constexpr Tagged_t kreplace_symbol = 0x5349;
  static constexpr Tagged_t kspecies_symbol = 0x5359;
  static constexpr Tagged_t ksplit_symbol = 0x5369;
  static constexpr Tagged_t kto_primitive_symbol = 0x5379;
  static constexpr Tagged_t kis_concat_spreadable_symbol = 0x5389;
  static constexpr Tagged_t kEmptySlowElementDictionary = 0x5399;
  static constexpr Tagged_t kEmptySymbolTable = 0x53bd;
  static constexpr Tagged_t kUndefinedContextCell = 0x53d9;
  static constexpr Tagged_t kEmptyOrderedHashMap = 0x53f1;
  static constexpr Tagged_t kEmptyOrderedHashSet = 0x5405;
  static constexpr Tagged_t kEmptyFeedbackMetadata = 0x5419;
  static constexpr Tagged_t kGlobalThisBindingScopeInfo = 0x5425;
  static constexpr Tagged_t kEmptyFunctionScopeInfo = 0x5445;
  static constexpr Tagged_t kNativeScopeInfo = 0x546d;
  static constexpr Tagged_t kShadowRealmScopeInfo = 0x5485;
  static constexpr Tagged_t kManyClosuresCell = 0x549d;
  static constexpr Tagged_t kPreallocatedNumberStringTable = 0x54ad;
...
static constexpr std::array<Tagged_t, 905> StaticReadOnlyRootsPointerTable = {
